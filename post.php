<?php 
			...
			if (isset($_GET['post_id'])) {
				...
				$sql = "SELECT author_id,post_title,post_content,book_name,post_description,key_word,category_id,createdate,updatedate FROM posts 
				...
				//name author 
					$author_sql="SELECT author_name FROM `author` WHERE author_id='$author_id'";
					$query_author= mysqli_query($conn,$author_sql);
					$row_author=mysqli_fetch_array($query_author);
