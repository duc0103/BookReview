...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == "POST") {
		...
		if (isset($_POST['publish'])) {
			...
			// image process-----------------------------------
			$image ="";
			$image_dir= '../bootstrap/img/' . $_FILES['post_thumb']['name'];
				...
				if($numsAuthor>0){ 
					...
					$sql_index="select * from author where  author_name='$post_author'  limit 1";
					$query_index=mysqli_query($conn,$sql_index);
					$row=mysqli_fetch_array($query_index);
					$author_id=$row['author_id'];
							...
							<div id="post-category" class="collapse show">
							  <div class="card-body">
								...
								<div class="form-inline">
									<input type="radio" name="post_category" class="form-control form-category" 
