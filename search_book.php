<?php
  ...
  $query_search = "SELECT book_name,author_name, post_description,post_title ,post_slug,post_id ,book_image FROM posts  INNER JOIN author ON author.author_id=posts.author_id where book_name like'%$text%' or author_name like '%$text%' or post_title like '%$text%' ";
